...
export const MainHeader = () => {
  ...
  return (
    <div className="w-full h-14 bg-[#808080] text-gray-600  px-2 sm:px-0 sticky top-0 z-40 shadow-md shadow-gray-600 ">
      <div className="container mx-auto flex w-full h-full items-center justify-between space-x-3 relative">
          ...
          <div className="xl:min-w-[300px]">
            <Link to="/">
              <img
                    src={img}
                    alt="logo"
                     className="w-50 h-8 rounded-full"
                  />
            </Link>
          </div>
        </div>
        ...
        <form className="hidden sm:block sm:w-full" onSubmit={searchHeandler}>
          <div className="flex items-center  bg-gray-200 rounded-md ring-1 ring-emerald-800">
            ...
            />
            <button type="submit" className="pr-3 text-lg text-[#808080]">
              <BsSearch /> 
            </button>
          </div>
        </form>
        ...
        <div className="flex items-center space-x-3 relative">
          {userAccessToken && userInfo?._id ? (
            ...
            <div className="hidden sm:flex items-center">
              <Link
                to="/login"
                className="flex hover:bg-gray-700/50 p-2 rounded-md ease-out duration-100"
              >
              ...
              <Link
                to="/register"
                className=" hover:bg-gray-700/50 p-2 rounded-md ease-out duration-100"
              >
          ...
          >
            <span className="text-4xl text-white sm:pb-1 absolute hover:bg-gray-700/50 rounded-md">
              <AiOutlineShopping /> 
            </span>
            <p className="relative left-1 bottom-4 w-5 h-5 flex items-center justify-center bg-gray-600 text-white  rounded-full">
